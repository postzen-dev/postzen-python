...
class ProfileUpdateRequest(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=240)]] = Field(default=None, description="Pass an empty string or `null` to clear the description.")
    color: Optional[Annotated[str, Field(strict=True)]] = None
    is_default: Optional[StrictBool] = Field(default=None, description="Set to `true` to make this the default profile.", alias="isDefault")
