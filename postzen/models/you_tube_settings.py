...
class YouTubeSettings(BaseModel):
    ...
    tags: Optional[YouTubeSettingsTags] = None
    ...
    __properties: ClassVar[List[str]] = ["title", "privacyStatus", "tags", "categoryId", "madeForKids", "notifySubscribers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": YouTubeSettingsTags.from_dict(obj["tags"]) if obj.get("tags") is not None else None,
