...
class ConnectCompleteErrorResponse(BaseModel):
    ...
    """ # noqa: E501
    error: StrictStr = Field(description="Human-readable message, or a camelCase error code (for example `oauthCallbackFailed`) when the platform callback fails.")
    error_description: Optional[StrictStr] = Field(default=None, description="Additional detail reported by the platform, when available.", alias="errorDescription")
