...
class ApiPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "title", "content", "status", "scheduledFor", "timezone", "platforms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "platforms": [ApiPostPlatformResult.from_dict(_item) for _item in obj["platforms"]] if obj.get("platforms") is not None else None
        })
        return _obj
