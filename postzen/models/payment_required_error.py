...
class PaymentRequiredError(BaseModel):
    ...
    details: Optional[PaymentRequiredErrorDetails] = None
    __properties: ClassVar[List[str]] = ["error", "code", "reason", "documentationUrl", "dashboardUrl", "details"]

    @field_validator('code')
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['paymentRequired']):
            raise ValueError("must be one of enum values ('paymentRequired')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": PaymentRequiredErrorDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
