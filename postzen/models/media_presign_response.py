...
class MediaPresignResponse(BaseModel):
    ...
    """ # noqa: E501
    upload_url: StrictStr = Field(description="Use this URL for the direct file upload.", alias="uploadUrl")
    public_url: StrictStr = Field(description="Use this URL in post `mediaItems`.", alias="publicUrl")
    key: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["uploadUrl", "publicUrl", "key", "type"]
