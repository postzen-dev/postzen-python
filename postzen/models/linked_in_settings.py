...
class LinkedInSettings(BaseModel):
    ...
    def visibility_validate_enum(cls, value):
        ...
        if value not in set(['PUBLIC', 'CONNECTIONS']):
            raise ValueError("must be one of enum values ('PUBLIC', 'CONNECTIONS')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkedInSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkedInSettings from a dict"""
        if obj is None:
            return None
