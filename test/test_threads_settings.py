...
class TestThreadsSettings(unittest.TestCase):
    """ThreadsSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadsSettings:
        """Test ThreadsSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadsSettings`
        """
