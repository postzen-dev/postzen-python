...
class TestPostMediaItem(unittest.TestCase):
    """PostMediaItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostMediaItem:
        """Test PostMediaItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostMediaItem`
        """
        model = PostMediaItem()
        if include_optional:
