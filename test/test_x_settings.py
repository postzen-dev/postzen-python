...
class TestXSettings(unittest.TestCase):
    """XSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XSettings:
        """Test XSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XSettings`
        """
        model = XSettings()
        if include_optional:
            return XSettings(
